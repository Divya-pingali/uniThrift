    ...
    <>
      ...
      >
        ...
        <View style={{ flex: 1, alignItems: "flex-end" }}>
          <Button mode="text" onPress={signOut} textColor={theme.colors.error}>
            Sign Out
          </Button>
        </View>
      </View>
      ...
      >
        <View style={styles(theme).profileCard}>
          <View style={styles(theme).imageContainer}>
            {userImage ? (
              ...
              <Ionicons
                ...
                size={120}
                color="#ccc"
                style={styles(theme).defaultImage}
              />
            )}
          </View>
          <View style={styles(theme).textContainer}>
            ...
            {userEmail && (
              <Text variant="bodySmall" style={styles(theme).userEmail}>
                {userEmail}
              </Text>
            )}
            {userBio && (
              <Text variant="bodySmall" style={styles(theme).userBio}>
                {userBio}
              </Text>
            )}
          </View>
  ...
  return (
    <View style={styles(theme).container}>
      <FlatList
        ...
        ListEmptyComponent={
          <Text style={{ marginTop: 16 }}>No posts found.</Text>
        }
